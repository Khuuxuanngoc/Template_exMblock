...
class QTRSensors
{
  public:
    ...
    /// QTRReadMode_OnAndOff or QTRReadMode_OddEvenAndOff).
    ///
    ...
    /// ::QTREmitters enum. The default is QTREmitters_All.
    ///
    ...
    /// read mode is QTRReadMode_Manual, which tells read() to leave the
    /// emitters alone.
    void emittersOff(QTREmitters emitters = QTREmitters_All, bool wait = true);
    ...
    /// read mode is QTRReadMode_Manual, which tells read() to leave the
    /// emitters alone.
    void emittersOn(QTREmitters emitters = QTREmitters_All, bool wait = true);
    ...
    /// "emittersSelect(QTREmitters_Odd)" turns on the odd-numbered emitters
    ...
    /// ::QTRReadMode enum. The default is QTRReadMode_On. Manual emitter
    /// control with QTRReadMode_Manual is not supported.
    ///
    ...
    void calibrate(QTRReadMode mode = QTRReadMode_On);
    ...
    /// ::QTRReadMode enum. The default is QTRReadMode_On.
    ///
    /// Example usage:
    /// ~~~{.cpp}
    ...
    ///
    /// See \ref md_usage for more information and example code.
    void read(uint16_t * sensorValues, QTRReadMode mode = QTRReadMode_On);
    ...
    ///
    /// See \ref md_usage for more information and example code.
    void readCalibrated(uint16_t * sensorValues, QTRReadMode mode = QTRReadMode_On);
    ...
    ///
    /// See \ref md_usage for more information and example code.
    uint16_t readLineBlack(uint16_t * sensorValues, QTRReadMode mode = QTRReadMode_On)
    {
    ...
    ///
    /// See \ref md_usage for more information and example code.
    uint16_t readLineWhite(uint16_t * sensorValues, QTRReadMode mode = QTRReadMode_On)
    {
  ...
  private:
    ...
    QTRType _type = QTRType_Undefined;
